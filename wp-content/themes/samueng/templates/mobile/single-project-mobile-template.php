...
<div class="single-project-mobile-body layout-body-center">
    ...
    <?php
        ...
        if (!empty($release_date)) {
            echo '<div class="project-release-date"><strong>Release:</strong> ' . esc_html($release_date) . '</div>';
        } 
        else {
        }
    ?>
    <?php
        ...
        if ($field) {
            ...
            if (!empty($platforms)) {
                ...
                echo '<div class="project-platforms"><strong>Platforms:</strong> ' . esc_html(implode(', ', $labels)) . '</div>';
            }
        } 
    ?>
    ...
    <?php
        ...
        echo '<div class="features-container"><span class="features-label project-field-label">Features:</span>';
